    ...
    return (
        <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
                <h1 className="text-5xl font-extrabold tracking-tight lg:text-6xl bg-linear-to-r from-white to-zinc-500 bg-clip-text text-transparent">
                    Deep Researcher
                </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto pt-8">
                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 text-left space-y-2">
